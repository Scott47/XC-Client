        ...
        <form className="form--login" onSubmit={addToMeets}>
          <div>
            <div>
              ...
              <fieldset>
                <label className="card-text" htmlFor="course">
                  {" "}
                  Course{" "}
                </label>
                <input
              ...
              <fieldset>
                <label className="card-text" htmlFor="url">
                  {" "}
                  website{" "}
                </label>
                <input
              ...
              <fieldset>
                <label className="card-text" htmlFor="address">
                  {" "}
                  Address{" "}
                </label>
                <input
              ...
              <fieldset>
                <label className="card-text" htmlFor="distance">
                  {" "}
                  Distance{" "}
                </label>
                <input
              ...
              <fieldset>
                <label className="card-text" htmlFor="runners">
                  {" "}
                  Number of Runners{" "}
                </label>
                <input
